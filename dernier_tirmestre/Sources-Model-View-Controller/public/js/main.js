...
(function ($) {
  ...
  /*-----------------------------------------
     ...
     -----------------------------------------*/
  var $grid = $(
    ".banner-grid, .collection-page-grid, .category-page-grid, .lookbook, .custom-text-masonry-items"
  ).masonry({
    itemSelector:
      ".banner-item, .collection-page-item, .category-grid-item, .grid-lookbook, .custom-text-masonry-item",
  ...
  function sticky_pro_slider() {
    ...
    $(window).width() > 767
      ? $(".product-single-style2 .product-details-img").slick("unslick")
      : $(".product-single-style2 .product-details-img").slick("refresh");
  }
  sticky_pro_slider();
  ...
  function sticky_pro_slider_style4() {
    ...
    $(window).width() > 767
      ? $(".product-single-style4 .product-details-img .row").slick("unslick")
      : $(".product-single-style4 .product-details-img .row").slick("refresh");
  }
  ...
  function load_more() {
    ...
    $(".loadMore").on("click", function (e) {
      ...
      if ($(".product-load-more .item:hidden").length == 0) {
        $(".infinitpagin").html(
          '<div class="btn rounded loadMore">no more products</div>'
        );
      }
    });
  }
    ...
    $(".loadMoreFive").on("click", function (e) {
      ...
      if ($(".product-five-load-more .item:hidden").length == 0) {
        $(".infinitpagin-five").html(
          '<div class="btn rounded loadMoreFive">no more products</div>'
        );
      }
    });
  }
  ...
  function load_more_post() {
    ...
    $(".loadMorepost").on("click", function (e) {
      ...
      if ($(".blog--grid-load-more .article:hidden").length == 0) {
        $(".loadmore-post").html(
          '<div class="btn btn-lg rounded loadMorepost">No more Blog Post</div>'
        );
      }
    });
  }
